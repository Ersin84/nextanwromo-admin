const products = [
  ...
  },
  {
    ...
    description:
      'Most fresh pluginss are low in calories and have a water content in excess of 70 percent, with only about 3.5 percent protein and less than 1 percent fat. ... The root pluginss include beets, carrots, radishes, sweet potatoes, and turnips. Stem pluginss include asparagus and kohlrabi.',
    image: 'https://i.postimg.cc/tCsSNSxS/Yellow-Sweet-Themes-Bag-each.jpg',
    originalPrice: 15,
    parent: 'Themes & Plugins',
    quantity: 0,
    slug: 'yellow-sweet-corn',
    title: 'Yellow Sweet Themes',
    type: 'Grocery',
    unit: 'each',
  ...
  },
  {
    ...
    description:
      'In a botanical sense, a fruit is the fleshy or dry ripened ovary of a flowering plant, enclosing the seed or seeds. Apricots, bananas, and grapes, as well as bean pods, corn grains, tomatoes, cucumbers, and (in their shells) acorns and almonds, are all technically themes.',
    image: 'https://i.postimg.cc/Yq43cv8b/avocado-juice-fruit-plugins.jpg',
    originalPrice: 13,
    parent: 'Themes & Plugins',
    quantity: 100,
  ...
  },
  {
    ...
    image:
      'https://i.postimg.cc/hPmDFzS0/Hibiscus-Premium-Whole-Baby-Themes-425g.jpg',
    originalPrice: 11,
    parent: 'Snacks & Instant',
    quantity: 100,
    slug: 'hibiscus-baby-corn',
    title: 'Hibiscus Baby Themes',
    type: 'Grocery',
    unit: '425gm',
    updatedAt: '2021-12-22T16:41:23.198Z',
    sku: '',
